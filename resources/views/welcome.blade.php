                            ...
                            <div class="relative flex items-center gap-6 lg:items-end">
                                <div id="docs-card-content" class="flex items-start gap-6 lg:flex-col">
                                    ...
                                    <div class="pt-3 sm:pt-5 lg:pt-0">
                                        <h2 class="text-xl font-semibold text-black dark:text-white">Welkom op mijn
                                            website!</h2>

                                        <p class="mt-4 text-sm/relaxed">
                                            Dit is de standaard weergave van een nieuw opgezet Laravel project.
                                            Druk bezig achter de schermen om hier zelf wat moois te knutselen!
                                        </p>
                                    </div>
                                </div>
